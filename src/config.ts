...
export const SITE_LOGO = "/j-logo.png";
export const SITE_TITLE = "Jake";
export const SITE_URL = "https://astro-theme-Jake.muji.dev";
export const SITE_DESCRIPTION =
  `
  This is a space where creativity meets logic. As a passionate frontend engineer and dreamer inspired by the vastness of space, Jake shares insights on cutting-edge web development, personal projects, and the exploration of new technologies. With a unique blend of technical expertise and a love for innovation, this blog is a journey into problem-solving, design, and the limitless possibilities of the digital universe.
`;
export const ME_AVATAR = "/j-logo.png";
...
export const FOOTER_CONTENT = "Mr.Jake. All rights reserved.";
